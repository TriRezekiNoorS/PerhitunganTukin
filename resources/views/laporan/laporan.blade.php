        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <div class="box-title"><a href= "{{url('input-laporan')}}" class="btn bg-navy btn-flat margin">tambah</a> <a href= "{{url('cetak-pertanggal')}}"></a>
            </div>
            ...
            <div class="box-body">
              <table id="example2" class="table table-bordered table-hover">
                ...
                <tr>
                  ...
                  @endif
                  <td> <a href="{{url ('hapus-laporan/'.$item->id)}}" class="btn btn-danger btn-user btn-sm">Hapus</td>
                </tr>
               @endforeach
                </tbody>
              </table>
              <div>
                <a href="{{url ('cetak-laporan')}}" class="btn btn-primary"> Cetak </a>
              </div>
            </div>
