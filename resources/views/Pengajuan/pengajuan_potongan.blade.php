        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <div class="box-title"><a href= "{{url('input-pengajuanpotongan')}}" class="btn bg-navy btn-flat margin">tambah</a>
            </div>
            ...
            <div class="box-body">
              <table id="example2" class="table table-bordered table-hover">
                ...
                @foreach ($dtpengajuanpotongan as $item)
                <tbody>
                <tr>
                  ...
                  <td><a href="{{url ('edit-pengajuanpotongan/'.$item->id) }}" class="fa fa-edit"></a> <a href="{{ url ('hapus-pengajuanpotongan/'.$item->id) }}" class="fa fa-trash-o"></a></td>
                </tr>
              @endforeach
                </tbody>
              </table>
