      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            ...
            <!-- form start -->
            <div class="card-body">
              <form action="<?php echo e(url('simpan-gol/'.$golongan->id)); ?>" method="post">
                <?php echo e(csrf_field()); ?>

              <div class="box-body">
              
              <div class="form-group">
                  <label for="exampleInputid">Kode Golongan</label>
                  <input type="text" name="id" class="form-control"  placeholder="nip" value="<?php echo e($golongan->id); ?>">
                </div>

                <div class="form-group">
                  <label for="exampleInpunamapegawai">Nama Golongan</label>
                  <input type="text" name="namagolongan" class="form-control"  placeholder="namagolongan" value="<?php echo e($golongan->namagolongan); ?>">
                </div>
...
<?php /**PATH C:\laragon\www\PerhitunganTukin\resources\views/Data/edit-golongan.blade.php ENDPATH**/ ?>