      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            ...
            <!-- form start -->
              <div class="card-body">
              <form action="<?php echo e(url('simpan-grade')); ?>" method="post">
              ...
              <div class="box-body">
                <div class="form-group">
                  ...
                  <input type="id" name="id" class="form-control"  placeholder="Kode Grade">
                </div>

                <div class="form-group">
                  <label for="exampleInputgrade">Grade</label>
                  <input type="grade" name="grade" class="form-control"  placeholder="Grade">
                </div>
...
<script>
  $(function () {
    ...
    <?php /**PATH C:\laragon\www\PerhitunganTukin\resources\views/Data/input_grade.blade.php ENDPATH**/ ?>