      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            ...
            <!-- form start -->
              <div class="card-body">
              <form action="<?php echo e(url('simpanpegawai')); ?>" method="post">
              ...
              <div class="form-group">
                  ...
                  <input type="text" id="nipInput" name="id" class="form-control" placeholder="nip">
                  <span id="errorNip" style="color: red;"></span>
              </div>

                <div class="form-group">
                  <label for="exampleInpunamapegawai">Nama Pegawai</label>
                  <input type="text" name="namapegawai" class="form-control"  placeholder="namapegawai">
                </div>

                <div class="form-group">
                  <label for="exampleInputgolongan_id">Golongan</label>
                  <select type="text" name="golongan_id" class="form-control"  placeholder="golongan_id">
                  <option value="" disabled selected>pilih golongan</option>
                                    ...
                                    <option value= "<?php echo e($item->id); ?>"><?php echo e($item->namagolongan); ?> </option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </select>
                </div>

                <div class="form-group">
                <label for="exampleInputjabatan_id">Pilih Jabatan</label>
                  <select type="text" name="jabatan_id" class="form-control"  placeholder="jabatan_id">
                  <option value="" disabled selected>pilih jabatan</option>
                                    ...
                                    <option value= "<?php echo e($item->id); ?>"><?php echo e($item->namajabatan); ?> </option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </select>
                </div>

                <div class="form-group">
                  <label for="exampleInputgrade_id">Grade</label>
                  <select type="text" name="grade_id" class="form-control"  placeholder="grade">
                  <option value="" disabled selected>pilih Grade</option>
                                    ...
                                    <option value= "<?php echo e($item->id); ?>"><?php echo e($item->grade); ?> </option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </select>
                </div>

                <div class="form-group">
                  <label for="exampleInputsatker_id">Nama Satker</label>
              ...
              <div class="box-footer">
                <button type="submit" class="btn bg-maroon margin">Submit</button> <a href= "<?php echo e(url('pegawai')); ?>" class="btn bg-olive margin">Kembali</a>
              </div>
            </form>
              </div>
...
<script>
  document.getElementById('nipInput').addEventListener('input', function() {
    const nipValue = this.value;
    let errorMessage = '';

    if (nipValue.length < 18) {
        errorMessage = 'NIP harus memiliki setidaknya 18 karakter.';
    } else if (nipValue.length > 16) {
        errorMessage = 'NIP tidak boleh melebihi 18 karakter.';
    }

    document.getElementById('errorNip').textContent = errorMessage;
});
</script>
</body>
</html>
    ...
    <?php /**PATH C:\laragon\www\PerhitunganTukin\resources\views/Data/inputpegawai.blade.php ENDPATH**/ ?>