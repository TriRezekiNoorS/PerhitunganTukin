        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <div class="box-title"><a href= "<?php echo e(url('inputjabatan')); ?>" class="btn bg-navy btn-flat margin">tambah</a>
            </div>
            ...
            <div class="box-body">
              <table id="example2" class="table table-bordered table-hover">
                ...
                <tr>
                  ...
                  <td><?php echo e($item->namajabatan); ?></td>
                  <td> <a href="<?php echo e(url ('edit-jabatan/'.$item->id)); ?>" class="btn btn-warning btn-user btn-sm">Edit</a> <a href="<?php echo e(url ('hapus-jabatan/'.$item->id)); ?>" class="btn btn-danger btn-user btn-sm">Hapus</span></td>
                </tr>
...
<?php /**PATH C:\laragon\www\PerhitunganTukin\resources\views/Data/jabatan.blade.php ENDPATH**/ ?>