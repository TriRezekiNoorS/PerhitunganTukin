...
<div class="login-box">
  ...
  <a href="#"><b>Perhitungan Tukin</b><h4>Kanwil Kemenkumham Kalimantan Selatan</h4></a> 
     <!---->
  </div>
  <!-- /.login-logo -->
  <div class="login-box-body">
    ...
    <form action="<?php echo e(url('simpan-register')); ?>" method="post">
...
<?php /**PATH C:\laragon\www\PerhitunganTukin\resources\views/Pengguna/register.blade.php ENDPATH**/ ?>