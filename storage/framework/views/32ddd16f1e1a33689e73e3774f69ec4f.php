      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            ...
            <!-- form start -->
            <div class="card-body">
              <form action="<?php echo e(url('simpan-kel/'.$kelas->id)); ?>" method="post">
                <?php echo e(csrf_field()); ?>

              <div class="box-body">
              
              <div class="form-group">
                  <label for="exampleInputid">Kode Kelas</label>
                  <input type="text" name="id" class="form-control"  placeholder="Kode" value="<?php echo e($kelas->id); ?>">
                </div>

                <div class="form-group">
                  <label for="exampleInpunamapegawai">Nama Kelas</label>
                  <input type="text" name="namakelas" class="form-control"  placeholder="nama kelas" value="<?php echo e($kelas->namakelas); ?>">
                </div>
...
<?php /**PATH C:\laragon\www\PerhitunganTukin\resources\views/Data/edit-kelas.blade.php ENDPATH**/ ?>