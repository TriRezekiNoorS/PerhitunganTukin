        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Edit Satuan Kerja</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <div class="card-body">
              <form action="<?php echo e(url('simpanperubahansatker/'.$dtsatker->id)); ?>" method="post">
                <?php echo e(csrf_field()); ?>

              <div class="box-body">
              
              <div class="form-group">
                  <label for="exampleInputid">Kode Satker</label>
                  <input type="text" name="id" class="form-control"  placeholder="nip" value="<?php echo e($dtsatker->id); ?>">
                </div>

                <div class="form-group">
                  <label for="exampleInpunamapegawai">Nama Satker</label>
                  <input type="text" name="namasatker" class="form-control"  placeholder="namasatker" value="<?php echo e($dtsatker->namasatker); ?>">
                </div>

                <div class="form-group">
                  <label for="exampleInputgolongan_id">Kelas</label>
                  <select type="text" name="kelas_id" class="form-control"  placeholder="kelas_id">
                  <option value="<?php echo e($dtsatker->kelas_id); ?>" disabled selected>Pilih Kelas</option>
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="alamat" class="form-control"  placeholder="alamat" value="<?php echo e($dtsatker->alamat); ?>">
                </div>
...
<?php /**PATH C:\laragon\www\PerhitunganTukin\resources\views/Pengguna/edit-satker.blade.php ENDPATH**/ ?>