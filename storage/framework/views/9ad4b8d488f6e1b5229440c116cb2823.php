        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <div class="box-title"><a href= "<?php echo e(url('input_kelas')); ?>" class="btn bg-navy btn-flat margin">tambah</a>
            </div>
            ...
            <div class="box-body">
              <table id="example2" class="table table-bordered table-hover">
                ...
                <tr>
                  ...
                  <td><?php echo e($item->namakelas); ?></td>
                  <td><a href="<?php echo e(url ('edit-kelas/'.$item->id)); ?>" class="btn btn-warning btn-user btn-sm">Edit</a> <a href="<?php echo e(url ('hapus-kelas/'.$item->id)); ?>" class="btn btn-danger btn-user btn-sm">Hapus</a></td>
                </tr>
...
<?php /**PATH C:\laragon\www\PerhitunganTukin\resources\views/Data/kelas.blade.php ENDPATH**/ ?>