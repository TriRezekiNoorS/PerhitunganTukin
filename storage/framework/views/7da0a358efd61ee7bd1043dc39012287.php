      ...
      <div class="row">
        <div class="col-xs-12">
          <div class="box">
            ...
            <a href = "<?php echo e(url ('status')); ?>"></a>
            </div>
            ...
            <div class="box-body">
              <table id="example2" class="table table-bordered table-hover">
                ...
                <td>
                <a href="<?php echo e(url('validasi', ['id' => $item->id])); ?>">
...
<?php /**PATH C:\laragon\www\PerhitunganTukin\resources\views/laporan/status.blade.php ENDPATH**/ ?>