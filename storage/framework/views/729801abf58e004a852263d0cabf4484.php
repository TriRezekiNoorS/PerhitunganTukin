        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <div class="box-title"><a href= "<?php echo e(url('input-laporan')); ?>" class="btn bg-navy btn-flat margin">tambah</a> <a href= "<?php echo e(url('cetak-pertanggal')); ?>"></a>
            </div>
            ...
            <div class="box-body">
              <table id="example2" class="table table-bordered table-hover">
                ...
                <tr>
                  ...
                  <td>
                  <label class="label label-success">Validasi</label>
                  </td>
                  <?php endif; ?>
                  <td> <a href="<?php echo e(url ('hapus-laporan/'.$item->id)); ?>" class="btn btn-danger btn-user btn-sm">Hapus</td>
                </tr>
               <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </tbody>
              </table>
              <div>
                <a href="<?php echo e(url ('cetak-laporan')); ?>" class="btn btn-primary"> Cetak </a>
              </div>
            </div>
...
<?php /**PATH C:\laragon\www\PerhitunganTukin\resources\views/laporan/laporan.blade.php ENDPATH**/ ?>