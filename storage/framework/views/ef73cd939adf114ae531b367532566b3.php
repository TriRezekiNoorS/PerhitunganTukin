      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            ...
            <!-- form start -->
            <div class="card-body">
              <form action="<?php echo e(url('simpan-grade/'.$grade->id)); ?>" method="post">
                <?php echo e(csrf_field()); ?>

              <div class="box-body">
              
              <div class="form-group">
                  <label for="exampleInputid">Kode Grade</label>
                  <input type="text" name="id" class="form-control"  placeholder="kode Grade" value="<?php echo e($grade->id); ?>">
                </div>

                <div class="form-group">
                  <label for="exampleInpunamapegawai">Grade</label>
                  <input type="text" name="grade" class="form-control"  placeholder="grade" value="<?php echo e($grade->grade); ?>">
                </div>
...
<?php /**PATH C:\laragon\www\PerhitunganTukin\resources\views/Data/edit-grade.blade.php ENDPATH**/ ?>