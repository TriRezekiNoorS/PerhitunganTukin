        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <div class="box-title"><a href= "<?php echo e(url('input-jenispotongan')); ?>" class="btn bg-navy btn-flat margin">tambah</a>
            </div>
            ...
            <div class="box-body">
              <table id="example2" class="table table-bordered table-hover">
                ...
                <tr>
                  ...
                  <td><a href="<?php echo e(url ('hapus-jenispotongan/'.$item->id)); ?>" class="btn btn-danger btn-user btn-sm">Hapus</span></td>
                </tr>
...
<?php /**PATH C:\laragon\www\PerhitunganTukin\resources\views/Pengajuan/jenis-potongan.blade.php ENDPATH**/ ?>