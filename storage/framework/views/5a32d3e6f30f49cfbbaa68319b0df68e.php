      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            ...
            <!-- form start -->
            <div class="card-body">
              <form action="<?php echo e(url('simpanperubahan/'.$dtpegawai->id)); ?>" method="post">
                <?php echo e(csrf_field()); ?>

              <div class="box-body">
              
              <div class="form-group">
                  <label for="exampleInputid">NIP</label>
                  <input type="text" name="id" class="form-control"  placeholder="nip" value="<?php echo e($dtpegawai->id); ?>">
                </div>

                <div class="form-group">
                  <label for="exampleInpunamapegawai">Nama Pegawai</label>
                  <input type="text" name="namapegawai" class="form-control"  placeholder="namapegawai" value="<?php echo e($dtpegawai->namapegawai); ?>">
                </div>
                ...
                <div class="form-group">
                  ...
                  <option value="<?php echo e($dtpegawai->golongan_id); ?>" disabled selected>pilih golongan</option>
                ...
                <label for="exampleInputjabatan_id">Pilih Jabatan</label>
                  ...
                  <option value="<?php echo e($dtpegawai->jabatan_id); ?>" disabled selected>pilih jabatan</option>
                ...
                <div class="form-group">
                  ...
                  <option value="<?php echo e($dtpegawai->grade_id); ?>" disabled selected>pilih Grade</option>
...
<?php /**PATH C:\laragon\www\PerhitunganTukin\resources\views/Data/edit_pegawai.blade.php ENDPATH**/ ?>