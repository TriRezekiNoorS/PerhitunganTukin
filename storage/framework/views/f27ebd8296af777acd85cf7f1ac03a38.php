        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <div class="box-title"><a href= "<?php echo e(url('input-grade')); ?>" class="btn bg-navy btn-flat margin">tambah</a>
            </div>
            ...
            <div class="box-body">
              <table id="example2" class="table table-bordered table-hover">
                ...
                <tr> 
                  ...
                  <td><a href="<?php echo e(url ('edit-grade/'.$item->id)); ?>" class="btn btn-warning btn-user btn-sm">Edit</a> <a href="<?php echo e(url ('hapus-grade/'.$item->id)); ?>" class="btn btn-danger btn-user btn-sm">Hapus</a></td>
                </tr>
...
<?php /**PATH C:\laragon\www\PerhitunganTukin\resources\views/Data/grade.blade.php ENDPATH**/ ?>