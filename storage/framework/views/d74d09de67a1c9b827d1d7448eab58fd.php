      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            ...
            <!-- form start -->
              <div class="card-body">
              <form action="<?php echo e(url('simpan-jenispotongan')); ?>" method="post">
                <?php echo e(csrf_field()); ?>

              <div class="box-body">
                <div class="form-group">
                  <label for="exampleInputid">Kode Jenis</label>
                  <input type="id" name="id" class="form-control"  placeholder="Kode Jenis">
                </div>
...
<script>
  $(function () {
    ...
    <?php /**PATH C:\laragon\www\PerhitunganTukin\resources\views/Pengajuan/input-jenispotongan.blade.php ENDPATH**/ ?>