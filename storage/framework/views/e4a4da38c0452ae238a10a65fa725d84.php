        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <div class="box-title"><a href= "<?php echo e(url('inputpegawai')); ?>" class="btn btn-primary btn-user btn-block">Tambah</a>
            </div>
            ...
            <div class="box-body">
              <table id="example2" class="table table-bordered table-hover">
                ...
                <tr>
                  ...
                  <td><span class="btn btn-warning btn-user btn-sm">Edit</span> <span class="btn btn-danger btn-user btn-sm">Hapus</span></td>
                </tr>
...
<?php /**PATH C:\laragon\www\PerhitunganTukin\resources\views/Pengguna/pegawai.blade.php ENDPATH**/ ?>