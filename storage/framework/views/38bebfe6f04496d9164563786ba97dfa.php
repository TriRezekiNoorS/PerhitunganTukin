      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            ...
            <!-- form start -->
              <div class="card-body">
              <form action="<?php echo e(url('simpanjabatan')); ?>" method="post">
                <?php echo e(csrf_field()); ?>

              <div class="box-body">
                <div class="form-group">
                  <label for="exampleInputid">Kode Jabatan</label>
                  <input type="id" name="id" class="form-control"  placeholder="Kode Jabatan">
                </div>

                <div class="form-group">
                  <label for="exampleInpunamajabatan">Nama Jabatan</label>
                  <input type="namasatker" name="namajabatan" class="form-control"  placeholder="namajabatan">
                </div>
...
<script>
  $(function () {
    ...
    <?php /**PATH C:\laragon\www\PerhitunganTukin\resources\views/Data/inputjabatan.blade.php ENDPATH**/ ?>