...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Cetak Pertanggal/Bulan/Tahun Laporan
          ...
          <div class="box box-primary">
            ...
            <!-- form start -->
              ...
              <div class="box-footer">
                <a href="" class="btn bg-navy btn-flat margin">Cetak <i class="fa fa-print"></i></a>
              </div>
            </form>
              </div>
...
<script>
  $(function () {
    ...
    <?php /**PATH C:\laragon\www\PerhitunganTukin\resources\views/Laporan/cetak-pertanggal.blade.php ENDPATH**/ ?>