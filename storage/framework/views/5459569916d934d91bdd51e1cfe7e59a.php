      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            ...
            <!-- form start -->
              <div class="card-body">
              <form action="<?php echo e(url('simpan-potongan')); ?>" method="post">
...
<script>
  $(function () {
    ...
    <?php /**PATH C:\laragon\www\PerhitunganTukin\resources\views/Perhitungan/inputpotongan.blade.php ENDPATH**/ ?>