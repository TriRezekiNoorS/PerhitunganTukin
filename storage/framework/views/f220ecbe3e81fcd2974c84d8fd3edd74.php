      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            ...
            <!-- form start -->
            <div class="card-body">
              <form action="<?php echo e(url('simpan-jab/'.$jabatan->id)); ?>" method="post">
                <?php echo e(csrf_field()); ?>

              <div class="box-body">
              
              <div class="form-group">
                  <label for="exampleInputid">Kode Jabatan</label>
                  <input type="text" name="id" class="form-control"  placeholder="nip" value="<?php echo e($jabatan->id); ?>">
                </div>

                <div class="form-group">
                  <label for="exampleInpunamapegawai">Nama Jabatan</label>
                  <input type="text" name="namajabatan" class="form-control"  placeholder="namapegawai" value="<?php echo e($jabatan->namajabatan); ?>">
                </div>
...
<?php /**PATH C:\laragon\www\PerhitunganTukin\resources\views/Data/edit-jabatan.blade.php ENDPATH**/ ?>